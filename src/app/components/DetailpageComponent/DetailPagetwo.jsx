...
const DetailPagetwo = () => {
  return (
    <>
      <div className="bg-shades-white d-lg-none d-flex flex-column gap-15 p-2 mt-2">
        <div className="p-lg-3 d-flex flex-row justify-content-between">
          <div className="d-flex flex-column">
            <span className="fs-18 fs-lg-24 line-height-35 font-weight-50 font-weight-semibold color-shades-black">
              Hourly rental
            </span>
            <div className="d-flex default-plp-feature-label-desk align-items-center p-0">
              ...
              <span className="fs-14 line-height-25 font-weight-normal text-nowrap text-white">
                Available tomorrow
              </span>
            </div>
          </div>
          <div className="d-flex flex-column py-1">
            <div className="d-flex flex-row justify-content-end">
              <div className="fs-11 font-weight-bold text-uppercase text-white price-per-hour-color letter-spacing-1 line-height-15 text-right">
                Price per hour
              </div>
            </div>
            <span className="fs-24 font-weight-normal line-height-35 text-white text-right">
              $<span>93</span>
            </span>
          </div>
        </div>{" "}
        <div className="p-3 mt-3 bg-shades-100 rounded-small">
          <div className="d-flex flex-column gap-5">
            <div className="d-flex align-items-center justify-content-between fs-14">
              <span className="color-shades-900">6 hours rental (minimum)</span>
              <span className="font-weight-semibold text-white">
                $<span>560</span>
              </span>
            </div>
            <div className="d-flex align-items-center justify-content-between fs-14">
              <span className="color-shades-900">12 hours rental</span>
              <div className="d-flex gap-5">
                <span className="font-weight-semibold fs-14  text-white line-height-20">
                  $<span>746</span>
                </span>
              </div>
            </div>
            <div className="d-flex align-items-center justify-content-between fs-14">
              <span className="color-shades-900">VAT Tax Applicable</span>
              <span className="font-weight-semibold text-white">+5%</span>
            </div>
            <div className="mt-2">
              <button
                className="w-100 d-flex mobile-main-cta-btn whatsapp_btn whatsapp_btn_js d-none btn btn-large btn-semantic-success d-none d-lg-flex"
                type="button"
              >
                <span className=""></span>
                <svg
                ...
                <span className="letter-spacing-0_2">WhatsApp</span>
              </button>
            </div>
          </div>{" "}
        </div>
        <div className="mt-1 mb-5 d-flex flex-column gap-5">
          <div className="d-flex align-items-center line-height-25 policyDesc">
            {/* <span className="color-semantic-success icon-thumbs-up mr-2"></span> */}
            <FaInfoCircle className="color-semantic-success icon-thumbs-up mr-2" />
            <span className="fs-14 font-weight-normal color-shades-black">
              <span>No deposit needed</span>
            </span>
          </div>
          <span
            className="d-flex align-items-center fs-14 line-height-25 font-weight-normal color-shades-700 text-truncate"
            title="Minimum 6 hours rental"
          >
            {/* <i className="icon-info fs-18 d-lg-none d-flex color-shades-orange mr-2"></i> */}
            <FaInfoCircle className="color-semantic-success icon-thumbs-up mr-2" />
            <span className="color-shades-black">Minimum 6 hours rental</span>
          </span>
          <div className="d-flex align-items-center line-height-25">
            {/* <span className="color-shades-500 icon-info mr-2"></span> */}
            <FaInfoCircle className="color-semantic-success icon-thumbs-up mr-2" />
            <span className="fs-14 font-weight-normal color-shades-black">
          ...
          <div className="d-none d-lg-block py-3 px-3 show-body show-body-modal">
            ...
            <div className="mb-3">
              <div className="d-flex align-items-center rounded-small py-1 availability-label min-height-35 color-semantic-success">
                <span className="fs-14 line-height-25 ml-2">Available now</span>
              </div>
              ...
              <div
                className="d-flex align-items-center rounded-small min-height-35 policyDesc"
            ...
            <button className="w-100 mb-3 btn-medium contact_btn btn btn-semantic-success d-none d-lg-flex">
